...
#include <memory>
#include "../../AirPlaneCraft/health.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_health_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_health_t qt_meta_stringdata_health = {
    {
QT_MOC_LITERAL(0, 0, 6) // "health"
...
QT_INIT_METAOBJECT const QMetaObject health::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsTextItem::staticMetaObject>(),
    qt_meta_stringdata_health.data,
    qt_meta_data_health,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *health::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_health.stringdata0))
