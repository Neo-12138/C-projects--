...
#include <memory>
#include "../../recognize_server/QfaceObject.h"
...
QT_MOC_LITERAL(5, 40, 10), // "faceRegist"
QT_MOC_LITERAL(6, 51, 8), // "cv::Mat&"
QT_MOC_LITERAL(7, 60, 9), // "faceimage"
QT_MOC_LITERAL(8, 70, 9) // "faceQuery"

    },
    "QfaceObject\0send_faceid\0\0int64_t\0"
    "faceid\0faceRegist\0cv::Mat&\0faceimage\0"
    "faceQuery"
};
...
void QfaceObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { int64_t _r = _t->faceRegist((*reinterpret_cast< cv::Mat(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< int64_t*>(_a[0]) = std::move(_r); }  break;
        case 2: { int _r = _t->faceQuery((*reinterpret_cast< cv::Mat(*)>(_a[1])));
